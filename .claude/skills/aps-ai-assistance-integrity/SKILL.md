---
name: aps-ai-assistance-integrity
description: "Guides a product team building an algorithm-problem-solving product (Baekjoon/LeetCode-style judge and learning platform) on designing AI hint, debug, and review features while protecting learning quality, assessment integrity, and trust. Use when the team asks how to design an AI hint feature, where help becomes a spoiler, whether AI may fix user code, whether to block AI in coding-test or contest mode, how AI use should affect learning scores, or what to do when AI states a wrong solution with false confidence. It produces product requirements, domain distinctions, scope/MVP boundaries, logging and progress-impact rules, and cheating, over-reliance, copyright, and privacy risks for planners and engineers, not algorithm solutions, competitive-programming code, or submission debugging."
metadata:
  role: specialist
  domain: algorithm-problem-solving
  title: "Algorithm AI Assistance & Integrity Expert"
  parent: aps-domain-architect
  source: "algo-experts/Activity-Area-Experts/aps_ai_assistance_integrity_expert.skill.md"
  triggers: "AI hint design, hint ladder, 스포일러, assistance level, L0-L7, contest mode AI, 코딩테스트 모드, cheating detection, 표절, over-reliance 과의존, user code privacy, false confidence, integrity guardrail, mode-based policy"
---
