<!-- SOURCE: https://github.com/fugazi/test-automation-skills-agents/blob/main/skills/api-testing/references/schema-validation.md | REPO: fugazi/test-automation-skills-agents | LICENSE: MIT | RETRIEVED: 2026-07-04 -->
